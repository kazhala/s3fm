    ...
    def __init__(self) -> None:
        self._kb_maps = {
            KBMode.normal: {
                ...
                "pane_scroll_down": [{"keys": "j"}],
                "pane_scroll_up": [{"keys": "k"}],
                "pane_scroll_down_page": [{"keys": "c-d"}],
                "pane_scroll_up_page": [{"keys": "c-u"}],
                "pane_scroll_top": [
                    {"keys": ["g", "g"]},
                ],
                "pane_scroll_bottom": [{"keys": "G"}],
                "pane_page_up": [{"keys": "c-y"}],
                "pane_page_down": [{"keys": "c-e"}],
                "pane_forward": [{"keys": "l"}, {"keys": Keys.Enter}],
                "pane_backword": [{"keys": "h"}],
                "pane_toggle_hidden_files": [{"keys": ["z"]}],
                "pane_switch_mode": [{"keys": ["c", "m"]}],
            },
            KBMode.command: {
